...
The classification head of the trained detection is then transformed into an [energy function](http://yann.lecun.com/exdb/publis/pdf/lecun-06.pdf) to label an instance as unknown or not.
