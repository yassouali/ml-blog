...
In order to mimic how we, as humans, experience the world around us, where we see objects, hear sounds, read words, feel textures and taste flavors, multi-modal action recognition consists of leveraging multiple modalities beyond a single visual modality such as audio and language, 
